...
var newOccasion = function newOccasion(req, res) {
  (0, _recepient.createOrFindRecepient)(req, res).then(function (recepientData, err) {
    (0, _user.findUser)(req.user.email).then(function (userData) {
...
var allOccasions = /*#__PURE__*/function () {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          return Promise.all(data.map( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(occasionArray) {
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    return _context.abrupt("return", new Promise(function (resolve, reject) {
                      return (0, _recepient.findRecepientById)(occasionArray.recepientDetails).then(function (recepientData) {
                        var returnDict = {
  ...
  return function allOccasions(_x, _x2) {
