...
var _emailHandler = require("../platform/emailHandler");
            ...
            _user["default"].findOne(filter).then(function (data) {
              if (data) {
                ...
                _user["default"].create({
                  ...
                  (0, _emailHandler.sendGridHandler)('akshayrangasai.d@gmail.com', 'notifications@dumbstartupideas.com', "New Signup " + profile.given_name, "details :" + data);
                  resolve(newAdd);
                });
              }
            })["catch"](function (err) {
