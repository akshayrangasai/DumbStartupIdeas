...
var authClient = new google.auth.OAuth2(GOOGLE_CLIENT, GOOGLE_SECRET, redirectURL);
...
var gmailHandler = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(from, to, subject, message) {
    var encodedMessage;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return constructMessage(from, to, subject, message);
        case 2:
  ...
  return function gmailHandler(_x6, _x7, _x8, _x9) {
...
var sendGridHandler = /*#__PURE__*/function () {
  ...
  return function sendGridHandler(_x10, _x11, _x12, _x13) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          toEmail = toHeader.concat(to);
          fromEmail = fromHeader.concat("<", from, ">");
          contentType = 'Content-Type: text/html; charset=utf-8';
          mimeVersion = 'MIME-Version: 1.0';
          subject_message = subject || '🤘 Greetings 🤘';
          utf8Subject = "=?utf-8?B?".concat(Buffer.from(subject_message).toString('base64'), "?=");
          subjectToSend = subjectString.concat(utf8Subject); //const message = message;
