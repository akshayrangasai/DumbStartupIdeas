...
function _constructMessage() {
  _constructMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(messageData) {
    var fromHeader, toHeader, subjectString, toEmail, fromEmail, contentType, mimeVersion, subject, utf8Subject, subjectToSend, message, messageParts, finalMessage, encodedMessage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          fromEmail = fromHeader.concat("<", messageData.fromEmail, ">");
          ...
          return _context.abrupt("return", encodedMessage);
        case 15:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          (0, _userAuthManager.getRefreshToken)(messageData.fromEmail).then(function (data) {
            authClient.setCredentials({
